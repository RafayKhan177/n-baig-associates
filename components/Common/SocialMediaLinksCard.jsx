const SocialMediaLinksCard = () => {
    return (
        <div class="flex flex-col bg-center bg-cover bg-no-repeat">
            <div class="grid place-items-center mx-auto p-10 sm:my-auto bg-white rounded-3xl space-y-10">
                <h1 class="text-5xl font-semibold text-blue-500">Follow on Social Media</h1>
